 ...
 * @author SEABIRDS-PC
 */
public class RecipientFrame extends javax.swing.JFrame {

    /**
     * Creates new form RecipientFrame
     */
    ...
    public RecipientFrame(String ha, String na) {
        initComponents();
    ...
    public final void showBlockchain()
    {
		...
		String hospname=firstName.trim()+" "+lastName.trim();
                ...
                {
                    jComboBox1.addItem(hospname.trim());
                    jComboBox2.addItem(hospname.trim());
		}
            }
	}
	catch(Exception e)
    ...
    private void initComponents() {
        ...
        jButton2.setText("View Organ Donar Details");
        ...
        jTabbedPane1.addTab("Organ Needed", jPanel3);
        ...
        jButton3.setText("View Medicine Donar Details");
        ...
        jTabbedPane1.addTab("Medicine Needed", jPanel4);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String hospitalName=jComboBox1.getSelectedItem().toString().trim();
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                String encryptedhospitalName1=rs.getString(6);
                ...
                String hospitalName1=Decrypt(encryptedhospitalName1.trim(),e2.trim(),m1.trim());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
		...
		String encryptedDescription=rs.getString(7); 
                ...
                String encryptedhospitalName1=rs.getString(9);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecipientFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new RecipientFrame().setVisible(true);
            }
        });
    }
